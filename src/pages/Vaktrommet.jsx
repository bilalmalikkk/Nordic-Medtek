...
export default function Vaktrommet() {
              ...
              <div className="grid md:grid-cols-3 gap-8 md:items-stretch">
                ...
                <div className="flex flex-col space-y-6">
                  ...
                  <div className="mt-auto">
                    <Link 
                      to="/products" 
                      state={{ from: '/vaktrommet' }}
                      className="inline-block bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition-all duration-300 w-full text-center"
                    >
                      {t('vaktrommet.serviceOptions.card1.button')}
                    </Link>
                  </div>
                </div>
                ...
                <div className="flex flex-col space-y-6">
                  ...
                  <div className="mt-auto">
                    <Link 
                      to="/products" 
                      state={{ from: '/vaktrommet' }}
                      className="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-all duration-300 w-full text-center"
                    >
                      {t('vaktrommet.serviceOptions.card2.button')}
                    </Link>
                  </div>
                </div>
