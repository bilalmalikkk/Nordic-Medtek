        ...
        <section className="py-16 w-full bg-gradient-to-b from-gray-50 to-white">
          <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Link 
                to="/fallalarm"
                className="group bg-white border-2 border-gray-200 rounded-2xl p-8 text-center hover:border-teal-500 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
              >
              ...
              >
                <h3 className="text-xl font-bold text-gray-900 group-hover:text-teal-600 transition-colors">
                  {t('faq.generalItems.fallSensors')}
                </h3>
              </Link>
              ...
              >
                <h3 className="text-xl font-bold text-gray-900 group-hover:text-teal-600 transition-colors">
                  {t('faq.generalItems.alarmButtons')}
                </h3>
              </Link>
              ...
              >
                <h3 className="text-xl font-bold text-gray-900 group-hover:text-teal-600 transition-colors">
                  {t('faq.generalItems.medicalFollowup')}
                </h3>
              </Link>
            </div>
